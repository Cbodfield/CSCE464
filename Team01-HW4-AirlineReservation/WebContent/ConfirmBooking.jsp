...
<head>
	...
	$( document ).ready(function() {
	  $("#accountnumber").on('input', function() {
		  ...
		  var bool = match.test($("#accountnumber").val());
	  ...
	  $("#routingnumber").on('input', function() {
		  var match = new RegExp(/^[0-9]*$/);
		  var bool = match.test($("#routingnumber").val());
	...
	function confirm_function(){
        ...
        ({
            type: "POST",
            url: '../../Team01-HW4-Banking/Bank;jsessionid=${pageContext.session.id}',
            dataType: 'json',
